...
public class FormPage {
    ...
    public FormPage setCard(String randomCard){
        cardSelector = randomCard;
        return this;
    }

    public FormPage setCardPath()
    {
        visaTextBox = By.xpath("/html/body/div[2]/form/div[6]/div/select/option["+cardSelector +"]");
        return this;
    }
    ...
    public FormPage fillCardType (){
        driver.findElement(visaTextBox).click();
        return this;
    }
    ...
    public FormPage fillExpireMonth (String expireMonth){
        driver.findElement(cardExpireMonth).sendKeys();
        return this;
    }
